...
namespace CanvasApi.Client {
    public class CanvasApiClient : ICanvasApiClient, IDisposable {
        ...
        private readonly Lazy<SisImportApiClient> SisImportsClient;
        private readonly Lazy<ReportApiClient> ReportsClient;
        ...
        public CanvasApiClient ( HttpClient client, IServiceProvider serviceProvider ) {
            ...
            this.SisImportsClient = this.SetLazy(() => new SisImports.SisImportApiClient(this));
            this.ReportsClient = this.SetLazy(() => new Reports.ReportApiClient(this));
        }
        ...
        public ISisImportApiClient SisImports => this.SisImportsClient.Value;
        public ISubmissionsApiClient Submissions => this.SubmissionsApiClient.Value;
        public IUsersApi Users => this.UsersClient.Value;
        public IReportApiClient Reports => this.ReportsClient.Value;

        //IReportApiClient ICanvasApiClient.Reports { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }


        //ICourseApiClient ICanvasApiClient.Courses { get => throw new NotImplementedException(); set => throw new NotImplementedException(); }
        ...
        //internal async Task<TResult> PagableApiOperationSingleProperty<TResult, TBody> (
        //    HttpMethod verb,
        //    string url,
        //    TBody body,
        //    PagingOptions pagingOptions = null,
        ...
        internal MultipartFormDataContent BuildMultipartHttpArguments ( [NotNull] IEnumerable<ValueTuple<string, string>> args ) {
        ...
        private HttpRequestMessage GenerateHttpRequest<TBody> ( HttpMethod method, string url, TBody body )
            ...
            if (body != null) {
                ...
                if (method == HttpMethod.Get && messageContent is MultipartFormDataContent multipartFormDataContent) {
                    ...
                    httpMessage = new HttpRequestMessage(method, requestUrl);
                }

                if (method == HttpMethod.Post && body is ByteArrayContent byteArrayContent) {
                    messageContent = byteArrayContent;
                }
            }
